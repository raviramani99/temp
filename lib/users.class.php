...
//        return $this->getData($sUSerSiteHandler, "ARRAY");
   ...
   /**
    ...
    public function verifyUserLink($sLink)
    {
        $sCode = $sLink;
        $sAndWhere = " verification_code = '$sCode' ";
        $sQuery = "SELECT 
                            verification_code,
                            mail_id
                        FROM
        ...
        $aGetVerificationData = $this->getList($sQuery);
        $aUserVerificationData['record'] = $this->getData($aGetVerificationData);
        return $aUserVerificationData;
        }
    ...
    public function inviteUser($aUsersRecord) {
            $sTableName = 'user_invitation';
            $aInsertFieldArray = array
                                    (
                                        'mail_id',
                                        'password',
            ...
            $aInsertValueArray = array
                                    ...
                                    array   
                                        (
                                            $aUsersRecord['user_email'],
                                            $aUsersRecord['password'],
                                            $aUsersRecord['verification_code'],
                                            0
                                        )
                                    );                                
            return $this->saveRecords($sTableName, $aInsertFieldArray, $aInsertValueArray);
